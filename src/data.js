...
export const languages = {
  vi: {
    ...
    contact: {
      ...
      formNote: "Tin nhắn sẽ được gửi trực tiếp đến email của tôi.",
      sendingMessage: "Đang gửi tin nhắn của bạn...",
      successMessage: "Cảm ơn bạn. Tin nhắn đã được gửi thành công.",
      errorMessage: "Không gửi được tin nhắn lúc này. Bạn có thể liên hệ trực tiếp qua email hoặc điện thoại.",
      mailFallbackMessage: "Ứng dụng email đã được mở với nội dung tin nhắn của bạn.",
  ...
  en: {
    ...
    contact: {
      ...
      formNote: "Your message will be sent directly to my email.",
      sendingMessage: "Sending your message...",
      successMessage: "Thank you. Your message has been sent successfully.",
      errorMessage: "The message could not be sent right now. You can contact me directly by email or phone.",
      mailFallbackMessage: "Your email app has been opened with the message content.",
      email: "toilaboi400@gmail.com",
      phone: "090 669 0582",
      github: "https://github.com/ngocthien2100",
      linkedin: "https://linkedin.com/in/ngocthien2100",
